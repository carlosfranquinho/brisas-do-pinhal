  ...
  climateChart = new Chart(canvas, {
    data: {
      ...
      datasets: [
        ...
        {
          // Coluna interna: normal climatológica da precipitação
          type: 'bar',
          label: 'Normal prec. (mm)',
          data: NORMALS_RAIN,
          backgroundColor: 'rgba(15,23,42,0.35)',
          borderColor: 'rgba(15,23,42,0.0)',
          borderWidth: 0,
          borderRadius: 3,
          yAxisID: 'yRain',
          order: 2,
        ...
        {
          // Linha tracejada: normal climatológica da temperatura
          type: 'line',
          label: 'Normal temp. (°C)',
          data: NORMALS_TEMP,
          ...NORMAL_LINE,
